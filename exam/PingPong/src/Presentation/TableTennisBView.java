/*
 * @(#)TableTennisBView.java 2.0	11/01/11
 *
 ...
 * @since   JDK1.0
 */
public class TableTennisBView extends javax.swing.JFrame implements GUIObserver {

    private javax.swing.JLabel jLball;
    private javax.swing.JLabel jLplayer;
    private javax.swing.JPanel jPanel1;
    private Icon nballIcon = new javax.swing.ImageIcon(getClass().getResource("/Presentation/nball.gif"));
    private Icon ballIcon = new javax.swing.ImageIcon(getClass().getResource("/Presentation/ball.gif"));

    /** 
     * Creates new form TableTennisBView
     */
    public TableTennisBView() {
        init();
    ...
    private void init() {
        ...
        jPanel1 = new Table("/Presentation/tableB.png");
        jPanel1.setLayout(null);
        jPanel1.setBackground(new java.awt.Color(102, 153, 0));
        jPanel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        //jPanel1.setBounds(0, 0, 311, 394);
        ...
        jLplayer.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Presentation/agentB.gif"))); // NOI18N
