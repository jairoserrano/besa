...
/**
 * This class represents a port BESA, which makes treatment of behaviors, guards
 * and events.
 *
...
public class PortBESA {
     ...
     * Events queue.
     */
    private final QueueBESA events;
    /**
     ...
     * Timeout event type.
     */
    private static final String TIMEOUT_EVENT_TYPE = "__TimeOutEventTypeBESA__";
    /**
     * Collection of threads synchronized in order to implement timeout and
     * periodic guard.
     */
    private final List<PeriodicThread> periodicThreads = Collections.synchronizedList(new ArrayList<PeriodicThread>());
    ...
    public PortBESA(GuardBESA guard) {
        this.guard = guard;
        this.behaviors = new ArrayList<>();                         //Initializes the behavior storage.
    ...
    /**
     * Create a new periodic thread with a wait time and a delay time
     * associated.
     *
    ...
    /**
     * This class represents a periodic thread in the system. This class is used
     * when there are periodic guards or multi-guards.
     *
     * @author SIDRe - Pontificia Universidad Javeriana
     * @author Takina - Pontificia Universidad Javeriana
     * @version 2.0, 11/01/11
