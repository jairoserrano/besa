...
final public class ChannelBESA implements Runnable {
    ...
    /**
     * Port list binds to the agent channel.
     */
    private final ArrayList<PortBESA> ports;
    /**
     * Flag that indicates the channel state.
     */
     ...
     */
    private final MBoxBESA mbox;
    /**
     * Flags that indicates if the agent is moving.
     */
    ...
    final public void run() {
        ...
        //--------------------------------------------------------------------//        
        while (ag.isAlive()) {
            if (ag.isAlive()) {  //For synchronized access. 
                ReportBESA.trace("Before of receive events onto agent's channel: " 
                        + ag.getAlias());
                //------------------------------------------------------------//
                ...
                ReportBESA.trace("After of receive events onto agent's channel: " 
                        + ag.getAlias() + ", with event: " + ev.getStamp());
                //------------------------------------------------------------//
     ...
     */
    private boolean processEvent(EventBESA ev) {
