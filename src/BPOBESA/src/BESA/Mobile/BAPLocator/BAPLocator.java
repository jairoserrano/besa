 ...
 * @since   JDK1.0
 */
@WebServiceClient(name = "BAPLocator", targetNamespace = "http://BESA.Mobile.BAPLocator/")//, wsdlLocation = "http://localhost:8080/besa/baplocator?wsdl")
public class BAPLocator extends Service {
     ...
     */
    public BAPLocator(URL GREETINGIMPLSERVICE_WSDL_LOCATION) {
