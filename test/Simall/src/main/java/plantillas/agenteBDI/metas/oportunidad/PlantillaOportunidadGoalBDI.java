 ...
 */
package SIMALL.plantillas.agenteBDI.metas.oportunidad;
 ...
 * @author Daniel
 */
public class PlantillaOportunidadGoalBDI extends GoalBDI{

    public PlantillaOportunidadGoalBDI(long id, RationalRole role, String description, GoalBDITypes type) {
