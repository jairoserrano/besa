 ...
 */
package SIMALL.plantillas.agenteBDI.metas.supervivencia;
 ...
 * @author Daniel
 */
public class PlantillaSupervivenciaGoalBDI extends GoalBDI{

    public PlantillaSupervivenciaGoalBDI(long id, RationalRole role, String description, GoalBDITypes type) {
