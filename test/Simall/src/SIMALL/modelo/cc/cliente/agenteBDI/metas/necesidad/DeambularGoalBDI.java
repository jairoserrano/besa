 ...
 */
package SIMALL.modelo.cc.cliente.agenteBDI.metas.necesidad;
 ...
 * @author Daniel
 */
public class DeambularGoalBDI extends GoalBDI{

    public DeambularGoalBDI(long id, RationalRole role, String description, GoalBDITypes type) {
