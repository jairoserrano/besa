 ...
 */
package SIMALL.plantillas.agenteBDI.metas.requerimiento;
 ...
 * @author Daniel
 */
public class PlantillaRequerimientoGoalBDI extends GoalBDI{

    public PlantillaRequerimientoGoalBDI(long id, RationalRole role, String description, GoalBDITypes type) {
