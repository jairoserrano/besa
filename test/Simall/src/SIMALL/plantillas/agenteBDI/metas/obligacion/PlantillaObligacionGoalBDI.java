 ...
 */
package SIMALL.plantillas.agenteBDI.metas.obligacion;
 ...
 * @author Daniel
 */
public class PlantillaObligacionGoalBDI extends GoalBDI{

    public PlantillaObligacionGoalBDI(long id, RationalRole role, String description, GoalBDITypes type) {
