 ...
 * @author jairo
 */
public class FibonacciContainer_05 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ReportBESA.info("Lanzando config/Container_05.xml");

            AdmBESA adminBesa = AdmBESA.getInstance("config/Container_05.xml");
            ...
            for (int i = 0; i < config.getNumberOfAgentsPerContainer(); i++) {
                Agents.add(
                        new FibonacciAgent(
                                "FiboAgente_05_" + String.valueOf(i),
                                estado,
                                Struct,
                                0.91
                        )
                ...
                Agents.get(i).start();
                adminBesa.registerAgent(Agents.get(i), "FiboAgente_05_" + String.valueOf(i), "FiboAgente_05_" + String.valueOf(i));
            }
