 ...
 * @author Daniel
 */
public class UsarServiciosBancariosGoalBDI extends GoalBDI{

    public UsarServiciosBancariosGoalBDI(long id, RationalRole role, String description, GoalBDITypes type) {
