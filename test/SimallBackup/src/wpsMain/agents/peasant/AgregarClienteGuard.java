...
import wpsMain.agents.peasant.IniciarLogroDeMetasGuard;
import wpsMain.agents.peasant.MensajePromocional;
import wpsMain.agents.peasant.PaqueteMensajesPromocionales;
import wpsMain.agents.peasant.RecibirMensajesPromocionalesGuard;
    ...
    public void funcExecGuard(EventBESA ebesa) {
        try{
            ...
            if(aliasLugarAnterior!=null){
                ...
                PeriodicDataBESA data = new PeriodicDataBESA(10, PeriodicGuardBESA.START_PERIODIC_CALL);
