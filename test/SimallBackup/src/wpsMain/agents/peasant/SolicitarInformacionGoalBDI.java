 ...
 * @author Daniel
 */
public class SolicitarInformacionGoalBDI extends GoalBDI{

    public SolicitarInformacionGoalBDI(long id, RationalRole role, String description, GoalBDITypes type) {
