...
public class PlantillaBDIAgent extends AgentBDI{
    ...
    public PlantillaBDIAgent(String alias, Believes believes, List<GoalBDI> goals, double threshold, StructBESA structBESA) throws KernelAgentExceptionBESA, ExceptionBESA {
