 ...
 * @author Daniel
 */
public class ComprarGoalBDI extends GoalBDI{
    
    public static final int ESTADO_SIN_INICIAR=0;
    public static final int ESTADO_FINALIZADA=1;
    
    public static final int ESTADO_EJECUCION_REALIZAR_COMPRA=2;
    public static final int ESTADO_ESPERA_TRASLADO_CLIENTE=3;
    

    public ComprarGoalBDI(long id, RationalRole role, String description, GoalBDITypes type) {
    ...
    public double evaluateViability(Believes blvs) throws KernellAgentEventExceptionBESA {
        ...
        switch(estado){
            case ESTADO_EJECUCION_REALIZAR_COMPRA:
                return 1;
