...
public class LoadContainer_04 {
    ...
    public static void main(String[] args) {
        ...
        int ContainerID = Integer.parseInt(LoadContainer_04.class.getName().split("_")[1]);
        ...
        try {
            ...
            Logger.getLogger(LoadContainer_04.class.getName()).log(Level.SEVERE, null, ex);
        }
